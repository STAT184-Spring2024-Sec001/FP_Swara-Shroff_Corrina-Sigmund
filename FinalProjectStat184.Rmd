...
#### add description about what the data is going to show and why we made this graph
...
#### describe what the visualisation shows

## Conclusions for Average Risk for Heart Attack by Age and Sex

#### what does this mean and how does it relate to our research question



## Income for Patients At Risk Heart Attack
```{r income levels in patients not at risk for heart attack}
...
categorize_income <- function(incomes) {
  if (incomes <= 50000) {
    return("$0 - $50,000")
...
heart_attack_pred_data1$Income_Category <- sapply(heart_attack_pred_data1$Income, categorize_income)

ggplot(heart_attack_pred_data1, aes(x = "", fill = Income_Category)) +
  geom_bar(stat = "count", width = 1) +
  coord_polar("y") +
  labs(title = "Income of Patients At Risk",
       fill = "Income Category") +
  theme_minimal() +
  theme(legend.position = "right")

```
## Income for Patients At Risk Heart Attack Visual Description
...
## Conclusions for Income for Patients At Risk Heart Attack
...
#### add description about what the table is going to show and why we made this table
