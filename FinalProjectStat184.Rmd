...
library(kableExtra)
library(janitor)
load(heart_attack_prediction_dataset.2)
library(dplyr)
...
```{r gender v. stress level}

stress_gender_data<-heart_attack_prediction_dataset.2  %>% 
...
## Physical Activity Days per Week V. Gender
